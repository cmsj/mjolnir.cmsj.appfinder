...
function ext.allfinder.app_from_name(name)
...
--  Returns:
--      application object or nil
function ext.allfinder.app_from_window_title(title)
...
function ext.allfinder.app_from_window_title_pattern(pattern)
...
function ext.allfinder.window_from_window_title(title)
